...
@section('content')
	 ...
	 {{ Form::model($adminData, array('route' => array('admins.update', $adminData->id), 'method' => 'PUT')) }}
		@if (count($errors) > 0)
...
@section('content_header')
	<h1> {{trans('messages.EditAdmin')}}<small>{{trans('messages.ModifyAdminDetails')}}</small></h1>
	<ol class="breadcrumb">
