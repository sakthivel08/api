...
@section('content')
	{{ Form::open(array('url' => array('/admin/users/add'), 'class' => 'form-horizontal', 'id' => 'useradd', 'files' => 'true', )) }}
		@if (count($errors) > 0)
		...
		<div class="box">
			<div class="box-body">
				...
				<!-- <div class="form-group">
					<label class="col-sm-2 control-label" for="status">{{trans('messages.Ver')}}</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						{{ Form::number('mobile', null, array('required' => '', 'class' => 'form-control', 'id' => 'mobile',  'placeholder' => trans('messages.Mobile')))}}
					</div>
				</div>
				<div class="form-group">
...
@section('content_header')
	<h1>{{trans('messages.AddUser')}}<small>{{trans('messages.NewUser')}}</small></h1>
	<ol class="breadcrumb">
